    ...
    @section('body')
        ...
        <div class="row">
            ...
            <div class="container mt-5">
                <h2 class="mb-4">Ajouter une Pedale</h2>
                <form action="{{ route('newPedal') }}" method="POST" enctype="multipart/form-data" class="border p-4 rounded">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control form-control-sm" id="productMaterial" name="material" placeholder="Entrez le materiaux du produit">
